...
namespace QuantityMeasurementApp.Implementation
{
    public class QuantityMeasurementImpl : IQuantityMeasurement
    {
        ...
        public void CompareWeight()
        {
            ...
            QuantityWeight firstLength = new QuantityWeight(ValueOne,unitOne);
            QuantityWeight secondLength = new QuantityWeight(ValueTwo,unitTwo);

            bool result = QuantityWeightService.Equals(firstLength,secondLength);
        ...
        public void ConvertWeight()
        {
            ...
            double result = QuantityWeight.Convert(sourceValue,sourceUnit,targetUnit);
            Console.WriteLine($"Converted Result: {result} {targetUnit}");
        }
        ...
        public void AddWeight()
        {
            ...
            QuantityWeight first = new QuantityWeight(ValueOne,unitOne);
            QuantityWeight second = new QuantityWeight(ValueTwo,unitTwo);

            QuantityWeight sum = QuantityWeight.Add(first,second);

            Console.WriteLine($"Result: Quantity({sum.Value}, {sum.Unit})");
        }

        public void AddWeightWithTargetUnit()
        {
            Console.WriteLine("Select Unit For First Value: ");
            WeightUnit unitOne = ReadWeightUnit();
