...
namespace QuantityMeasurementApp.Menu
{
    ...
    ///
    /// UC10 / UC11 / UC12 / UC14 DESIGN INTENT:
    ...
    /// - Allows new measurement categories (such as Volume and Temperature) to be integrated
    ...
    /// - Conversion
    ///
    /// Temperature arithmetic is intentionally not exposed from the menu.
    /// </summary>
    public class Menu
    {
        /// <summary>
        ...
        /// Runtime failures are caught and displayed so the application
        /// can continue serving the next request.
        /// </summary>
        public void Show()
        {
            while (true)
            {
                ...
                Console.WriteLine("\n----- UC12 / UC13 Arithmetic Operations -----");
                Console.WriteLine("13. Subtract Quantities");
                Console.WriteLine("14. Divide Quantities");

                Console.WriteLine("\n----- UC14 Temperature Operations -----");
                Console.WriteLine("15. Compare Temperatures");
                Console.WriteLine("16. Convert Temperature");
        ...
        ///
        /// UC14 PURPOSE:
        /// Demonstrates that the generic Quantity&lt;U&gt; architecture can support
        /// non-linear conversion categories such as temperature.
        ///
        /// DESIGN NOTE:
        /// Comparison semantics are delegated entirely to Quantity&lt;TemperatureUnit&gt;
        /// and the underlying temperature conversion rules.
        /// </summary>
        private void CompareTemperatures()
        {
            Console.WriteLine("Select first temperature unit:");
            TemperatureUnit unitOne = ReadTemperatureUnit();

            Console.Write("Enter first value: ");
            double valueOne = Convert.ToDouble(Console.ReadLine());

            Console.WriteLine("Select second temperature unit:");
            TemperatureUnit unitTwo = ReadTemperatureUnit();

            Console.Write("Enter second value: ");
            double valueTwo = Convert.ToDouble(Console.ReadLine());

            var first = new Quantity<TemperatureUnit>(valueOne, unitOne);
            var second = new Quantity<TemperatureUnit>(valueTwo, unitTwo);

            Console.WriteLine(first.Equals(second) ? "Equal" : "Not Equal");
        }

        /// <summary>
        /// Converts a temperature quantity from one unit to another.
        ///
        /// UC14 SUPPORTED UNITS:
        /// - Celsius
        /// - Fahrenheit
        /// - Kelvin
        ///
        /// DESIGN NOTE:
        /// The menu knows only source and target selection.
        /// All temperature conversion rules are delegated to the domain model.
        /// </summary>
        private void ConvertTemperature()
        {
            Console.WriteLine("Select source temperature unit:");
            TemperatureUnit source = ReadTemperatureUnit();

            Console.Write("Enter value: ");
            double value = Convert.ToDouble(Console.ReadLine());

            Console.WriteLine("Select target temperature unit:");
            TemperatureUnit target = ReadTemperatureUnit();

            var quantity = new Quantity<TemperatureUnit>(value, source);
            var result = quantity.ConvertTo(target);
        ...
        /// <summary>
        /// Reads a temperature unit selection from console input.
        ///
        /// UC14 AVAILABLE OPTIONS:
        /// 1 -> Celsius
        /// 2 -> Fahrenheit
        /// 3 -> Kelvin
        ///
        /// DESIGN NOTE:
        /// Temperature is integrated into the same menu structure as other
        /// categories, while still restricting unsupported arithmetic operations.
        /// </summary>
        /// <returns>Selected TemperatureUnit value.</returns>
